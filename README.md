...
This setup uses a variant of Eclipse EDC called [Eclipse Tractus-X](https://github.com/eclipse-tractusx), which includes the [Tractus-X Connector](https://github.com/eclipse-edc/Connector) Helm chart for deploying the control plane, data plane, and required dependencies such as PostgreSQL and HashiCorp Vault.
