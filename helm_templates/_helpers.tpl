...
{{- printf "http://%s-controlplane.%s:%v%s/token" ( include "txdc.fullname" $ ) .Release.Namespace $.Values.controlplane.endpoints.control.port $.Values.controlplane.endpoints.control.path -}}
{{- end }}
...
{{- printf "http://%s-dataplane.%s:%v%s" (include "txdc.fullname" . ) .Release.Namespace .Values.dataplane.endpoints.control.port  .Values.dataplane.endpoints.control.path -}}
{{- end }}
